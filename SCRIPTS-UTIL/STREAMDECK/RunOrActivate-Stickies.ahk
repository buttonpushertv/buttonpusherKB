...
;Stickies is a little different. It's always running in the Tray. This script will either Activate an exsisting window or open a new Stickie for use.

WindowTitle := "ahk_exe stickies.exe"

MsgBox,,Attempt,Trying to run or activate:`n%WindowTitle%,2
RunOrActivate(WindowTitle)
ExitApp
